...
export const Sidebar = ({
  ...
  return (
    <aside
      ...
      className={`relative h-screen flex-shrink-0 transition-all duration-300 ease-in-out bg-[#111827] border-r border-[#1E293B] flex flex-col z-20 select-none shadow-xl ${
